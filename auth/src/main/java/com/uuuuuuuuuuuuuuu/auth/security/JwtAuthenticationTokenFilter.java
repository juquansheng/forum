package com.uuuuuuuuuuuuuuu.auth.security;


import com.uuuuuuuuuuuuuuu.auth.config.JwtTokenUtil;
import com.uuuuuuuuuuuuuuu.auth.properties.Audience;
import com.uuuuuuuuuuuuuuu.model.constant.RedisConstant;
import com.uuuuuuuuuuuuuuu.model.global.SysConf;
import com.uuuuuuuuuuuuuuu.redis.utils.RedisUtil;
import com.uuuuuuuuuuuuuuu.util.util.CookieUtils;
import com.uuuuuuuuuuuuuuu.util.util.DateUtil;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (authHeader != null && authHeader.startsWith(tokenHead)) {
            ...
            if (StringUtils.isNotEmpty(onlineAdmin) && !jwtTokenUtil.isExpiration(token, base64Secret)) {
                ...
                // 得到两个日期相差的间隔，秒
                Integer survivalSecond = DateUtil.getSecondByTwoDay(expirationDate, nowDate);
