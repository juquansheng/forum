...
import com.uuuuuuuuuuuuuuu.feign.fallback.PictureFeignFallback;
...
public interface PictureFeignClient {
    ...
    Result getPicture(@RequestParam("fileIds") String fileIds, @RequestParam("code") String code);
    ...
    Result uploadPicsByUrl(FileVO fileVO);
    ...
    Result initStorageSize(@RequestParam("adminUid") String adminUid, @RequestParam("maxStorageSize") Long maxStorageSize);
    ...
    Result editStorageSize(@RequestParam("adminUid") String adminUid, @RequestParam("maxStorageSize") Long maxStorageSize);
    ...
    Result getStorageByAdminUid(@RequestParam("adminUidList") List<String> adminUidList);
}